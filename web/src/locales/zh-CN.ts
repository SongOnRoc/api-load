export default {
  ...
  keys: {
    ...
    copyAllKeysToClipboard: "复制所有密钥",
    copyValidKeysToClipboard: "复制有效密钥",
    copyInvalidKeysToClipboard: "复制无效密钥",
    copy: "复制",
    export: "导出",
    exportFileHint: ".txt 文件",
    batchActions: "批量操作",
    validate: "校验",
  ...
  subGroups: {
    ...
    statusManuallyDisabled: "已停用",
    enableSubGroup: "启用此子分组",
    disableSubGroup: "停用此子分组",
    toggleEnabledSuccess: "子分组启用状态已更新",
    parentAggregateCount: "被 {count} 个聚合分组引用",
    parentAggregateCountZero: "未被聚合分组引用",
    parentAggregateDrawerTitle: "归属聚合分组",
    parentAggregateSummary: "共 {count} 个聚合分组",
    searchParentAggregate: "搜索聚合分组名称",
    noMatchingParentAggregate: "无匹配的聚合分组",
    noParentAggregate: "未被任何聚合分组引用",
    copyAggregateGroup: "复制聚合分组",
    copyGroup: "确认复制",
    copyGroupSuccess: "聚合分组复制成功",
  },
  logs: {
    title: "日志",
