export default {
  ...
  keys: {
    ...
    toConfirmDeletion: "and all its keys.",
    ...
    noGroups: "No groups",
    noAggregateGroups: "No aggregate groups",
    noStandardGroups: "No standard groups",
    noKeys: "No keys",
    ...
    copyAllKeysToClipboard: "Copy All Keys",
    copyValidKeysToClipboard: "Copy Valid Keys",
    copyInvalidKeysToClipboard: "Copy Invalid Keys",
    copy: "Copy",
    export: "Export",
    exportFileHint: ".txt file",
    ...
    validKeys: "Valid",
    invalidKeys: "Invalid",
    restoreInvalid: "Restore Invalid",
  ...
  subGroups: {
    ...
    statusManuallyDisabled: "Paused",
    enableSubGroup: "Enable this sub-group",
    disableSubGroup: "Pause this sub-group",
    toggleEnabledSuccess: "Sub-group enabled state updated",
    parentAggregateCount: "Referenced by {count} aggregate groups",
    parentAggregateCountZero: "Not referenced by any aggregate group",
    parentAggregateDrawerTitle: "Parent Aggregate Groups",
    parentAggregateSummary: "{count} aggregate groups",
    searchParentAggregate: "Search aggregate group name",
    noMatchingParentAggregate: "No matching aggregate group",
    noParentAggregate: "Not referenced by any aggregate group",
    copyAggregateGroup: "Copy Aggregate Group",
    copyGroup: "Confirm Copy",
    copyGroupSuccess: "Aggregate group copied successfully",
  },
  logs: {
    title: "Logs",
