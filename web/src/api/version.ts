...
import type { GitHubRelease, VersionInfo } from "@/types/models";

export type { GitHubRelease, VersionInfo } from "@/types/models";
  ...
  private async fetchLatestVersion(): Promise<GitHubRelease | null> {
    try {
      const response = await axios.get(
        "https://api.github.com/repos/SongOnRoc/gpt-load/releases/latest",
        {
          timeout: 10000,
          headers: {
