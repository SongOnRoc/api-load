export default {
  ...
  keys: {
    ...
    toConfirmDeletion: "とすべてのキーを削除します。",
    confirmDelete: "削除を確認",
    copyGroup: "グループコピー",
    groupName: "グループ名",
    ...
    noGroups: "グループがありません",
    noAggregateGroups: "集計グループがありません",
    noStandardGroups: "標準グループがありません",
    noKeys: "キーがありません",
    ...
    copyAllKeysToClipboard: "すべてのキーをコピー",
    copyValidKeysToClipboard: "有効なキーをコピー",
    copyInvalidKeysToClipboard: "無効なキーをコピー",
    copy: "コピー",
    export: "エクスポート",
    exportFileHint: ".txt ファイル",
    batchActions: "一括操作",
    validate: "検証",
  ...
  subGroups: {
    ...
    statusManuallyDisabled: "一時停止",
    enableSubGroup: "このサブグループを有効化",
    disableSubGroup: "このサブグループを一時停止",
    toggleEnabledSuccess: "サブグループの有効状態が更新されました",
    parentAggregateCount: "{count} 個の集計グループから参照されています",
    parentAggregateCountZero: "どの集計グループからも参照されていません",
    parentAggregateDrawerTitle: "所属集計グループ",
    parentAggregateSummary: "全 {count} 個の集計グループ",
    searchParentAggregate: "集計グループ名を検索",
    noMatchingParentAggregate: "一致する集計グループはありません",
    noParentAggregate: "どの集計グループからも参照されていません",
    copyAggregateGroup: "集計グループをコピー",
    copyGroup: "コピーを確定",
    copyGroupSuccess: "集計グループが正常にコピーされました",
  },
  logs: {
    title: "ログ",
